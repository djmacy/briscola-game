...
public class BriscolaGUI extends JFrame {
    ...
    private void showGameWindow() {
        ...
        //creating new labels for the player1 card played
        ...
        dealButton.addActionListener(e -> {
            ...
            //assign the variables of each player's cards in their hands. This allows us to get the respective
            ...
            //variable that will be used to make sure each card is the same size
            scaledHeight = (int) ((double) scaledWidth / backOfCard.getIconWidth() * backOfCard.getIconHeight());

            //setting the bounds and back of card image for the cpu's cards
        ...
        nextRoundButton.addActionListener(e -> {
            ...
            if (deck.getDeck().size() > 1) {
                ...
                if (whoWon == 1) {
                    ...
                    //reassign first card that the user has since it's the last card
                    playerCard1 = hand1.getHand().get(0);
                    Icon scaledIconCard1 = scaleImage(playerCard1);
        ...
        player1Card2Button.addActionListener(e -> {
            ...
            if (whoWon == 1) {
                ...
                //set the second button to invisible and disabled and set player 1 played card to visible
                player1Card2Button.setVisible(false);
                player1Card2Button.setEnabled(false);
                player1PlayedCard.setVisible(true);

                //disable all other buttons so that they can't be pressed
                player1Card1Button.setEnabled(false);
                Icon scaledIconPlayerCard1 = scaleImage(playerCard1);
                player1Card1Button.setDisabledIcon(scaledIconPlayerCard1);
                player1Card3Button.setEnabled(false);
    ...
    /**
     * Send the user back to the main menu from the card points frame.
     */
    private void showMainMenuFrameFromCardPoints() {
    ...
    /**
     * Send the user back to the menu frame from scenario one frame.
     */
    private void showMainMenuFrameFromScenarioOne() {
    ...
    /**
     * Send the user back to the menu frame from the scenario two frame.
     */
    private void showMainMenuFrameFromScenarioTwo() {
    ...
    /**
     * Send the user back to the menu frame from the scenario three frame.
     */
    private void showMainMenuFrameFromScenarioThree() {
    ...
    /**
     * Shows the main instructions menu from the scenario page.
     */
    ...
    /**
     * Shows the main instruction page from the scenario two page.
     */
    ...
    /**
     * Shows the main instruction page from the scenario three page.
     */
    ...
    /**
     * Shows the points frame from scenario one frame.
     */
    ...
    /**
     * Shows the points frame from the scenario two frame.
     */
    ...
    /**
     * Shows the points frame from the scenario three frame.
     */
    ...
    /**
     * Shows the scenario one page from the points page.
     */
    ...
    /**
     * Shows the scenario two from card points page.
     */
    ...
    /**
     * Shows the scenario three frame from card points page.
     */
    ...
    /**
     * Shows the scenario two frame from the scenario one frame.
     */
    ...
    /**
     * Shows the scenario three frame from the scenario one frame.
     */
    ...
    /**
     * Show scenario one from scenario two frame.
     */
    ...
    /**
     * Show scenario three from scenario one frame.
     */
    ...
    /**
     * Show scenario one from scenario three frame.
     */
    ...
    /**
     * Show scenario two from scenario three frame.
     */
    ...
    /**
     * Shows the instructions image and contains all buttons to link to further instructions.
     */
    ...
    private void showCardPoints() {
        ...
        JButton mainMenu = new JButton("Main Menu");
        mainMenu.setBounds(gameWidth / 5 - 90, gameHeight - 100, 110, 50);
        mainMenu.addActionListener(e -> showMainMenuFrameFromCardPoints());
        mainMenu.setFocusPainted(false);
        contentPane.add(mainMenu);
    ...
    /**
     * Sends the user to the scenario frame for more instruction help.
     */
    private void showScenarioOne() {
        ...
        JButton mainMenu = new JButton("Main Menu");
        mainMenu.setBounds(gameWidth / 5 - 90, gameHeight - 100, 110, 50);
        mainMenu.addActionListener(e -> showMainMenuFrameFromScenarioOne());
        mainMenu.setFocusPainted(false);
        contentPane.add(mainMenu);
    ...
    /**
     * Sends the user to the second scenario frame for more game play instruction.
     */
    private void showScenarioTwo() {
        ...
        JButton mainMenu = new JButton("Main Menu");
        mainMenu.setBounds(gameWidth / 5 - 90, gameHeight - 100, 110, 50);
        mainMenu.addActionListener(e -> showMainMenuFrameFromScenarioTwo());
        mainMenu.setFocusPainted(false);
        contentPane.add(mainMenu);
    ...
    /**
     * Sends the user to the scenario three menu frame for more instruction help.
     */
    private void showScenarioThree() {
        ...
        JButton mainMenu = new JButton("Main Menu");
        mainMenu.setBounds(gameWidth / 5 - 90, gameHeight - 100, 110, 50);
        mainMenu.addActionListener(e -> showMainMenuFrameFromScenarioThree());
        mainMenu.setFocusPainted(false);
        contentPane.add(mainMenu);
